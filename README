...
#### Complied windows binaries of procurement-mod are available [here](http://stat.tvaals.net/procurement.html) or [mirrored on github](WindowsBinaries/procurement-mod-binaries-1.3.0-12.03.2014.zip)