...
namespace Procurement
{
    ...
    {
        public static string Version = "Procurement-mod 1.3.0-12.03.2014 (latest change: merged r200 changes (display corrupted hover) + total currency displayed in chaos) -";
